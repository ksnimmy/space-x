...
If the filters existed in the browser url, that would also be stored in the redux store and sent to client side to initiate the store. These filteres would show as preselected based on this state.
